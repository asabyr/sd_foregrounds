...
def firas():
    x = np.loadtxt('/Users/asabyr/Documents/SecondYearProject/sd_foregrounds/data/firas_monopole_spec_v1.txt')
    ffs = x[:, 0] + 0.
...
def firas2():
    z = np.loadtxt('/Users/asabyr/Documents/SecondYearProject/sd_foregrounds/templates/firassensitivity.txt')
    firasfreqs = z[0]*1.e9
    firasnoise = z[1]
